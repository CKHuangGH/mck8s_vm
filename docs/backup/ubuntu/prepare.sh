#!/bin/bash 
# KUBECONFIG=~/.kube/cluster0:~/.kube/cluster1:~/.kube/cluster2 kubectl config view --flatten > ~/.kube/config
# for i in {0..2}
# do
...
# helm install cilium cilium/cilium --version 1.9.3 --namespace kube-system
# sleep 5
# done
# sleep 30
