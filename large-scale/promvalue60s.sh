...
do
	...
	echo "            - '{instance=~\"10.$ip1.$ip2.12:9100\"}'" >> values.yaml
	echo "            - '{instance=~\"10.$ip1.$ip2.13:9100\"}'" >> values.yaml
	echo "            - '{instance=~\"10.$ip1.$ip2.14:9100\"}'" >> values.yaml
	echo "            - '{instance=~\"10.$ip1.$ip2.15:9100\"}'" >> values.yaml
	echo "            - '{instance=~\"10.$ip1.$ip2.16:9100\"}'" >> values.yaml
	echo "            - '{instance=~\"10.$ip1.$ip2.17:9100\"}'" >> values.yaml
	echo "            - '{instance=~\"10.$ip1.$ip2.18:9100\"}'" >> values.yaml
	echo "            - '{instance=~\"10.$ip1.$ip2.19:9100\"}'" >> values.yaml
	echo "            - '{instance=~\"10.$ip1.$ip2.20:9100\"}'" >> values.yaml
	echo "            - '{instance=~\"10.$ip1.$ip2.21:9100\"}'" >> values.yaml
